...
export const metadata: Metadata = {
  title: "Terms of Service | abLedger",
  description: "Terms of Service for abLedger - Business Management Platform",
}
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing or using abLedger ("Service"), you agree to be bound by these Terms of Service ("Terms"). 
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Permission is granted to temporarily use abLedger for business management purposes. This is the grant of a license, 
                not a transfer of title, and under this license you may not:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                <li>Modify or copy the materials</li>
                <li>Use the materials for any commercial purpose without written consent</li>
                <li>Attempt to decompile or reverse engineer any software contained in abLedger</li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                You are responsible for maintaining the security of your account and password. abLedger cannot and will not be 
                liable for any loss or damage from your failure to comply with this security obligation. You are responsible 
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                If you choose to upgrade to a paid plan, you agree to pay the fees associated with that plan. 
                Fees are billed in advance on a monthly or annual basis. All fees are non-refundable except as required by law.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your use of abLedger is also governed by our Privacy Policy. Please review our Privacy Policy to understand 
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall abLedger or its suppliers be liable for any damages (including, without limitation, 
                damages for loss of data or profit, or due to business interruption) arising out of the use or inability 
                to use abLedger, even if abLedger has been notified of the possibility of such damage.
              </p>
            </section>
