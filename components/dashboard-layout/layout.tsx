...
import { TrialNotificationWrapper } from "./trial-notification-wrapper"
...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <ProtectedRoute requireRole="TENANT_USER">
      <div className={`flex h-screen ${theme === "dark" ? "dark" : ""}`}>
        ...
        >
          ...
          <main className="flex-1 overflow-auto bg-white dark:bg-[#0F0F12] min-w-0">
            <div className="pt-2">
