...
export default function Sidebar() {
  ...
  const filteredMenuData: MenuSection[] = menuData.map((section) => ({
    ...section,
    items: section.items.filter((item) => {
      switch (item.id) {
        ...
        case 'sales':
          return canView('sales')
        case 'invoices':
          return canView('invoices')
        case 'customers':
          return canView('customers')
        case 'profile':
          return canView('profile')
        case 'team':
          return canView('team')
        case 'branding':
          return canView('branding')
        case 'billing':
          return canView('profile') // Billing uses profile permission
        default:
          return true
      }
    }),
